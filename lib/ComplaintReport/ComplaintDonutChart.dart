...
class ComplaintDonutChart extends StatefulWidget {
  const ComplaintDonutChart({Key? key}) : super(key: key);

  @override
  _ComplaintDonutChartState createState() => _ComplaintDonutChartState();
}

class _ComplaintDonutChartState extends State<ComplaintDonutChart> {
          ...
          child: PieChart(
            PieChartData(
              ...
              sections: [
                ...
                PieChartSectionData(
                  value: _complaintList.first.complaintType!.isEmpty.toString().length.toDouble(),
                  color: Colors.red,
                  radius: 10,
                ),
              ],
